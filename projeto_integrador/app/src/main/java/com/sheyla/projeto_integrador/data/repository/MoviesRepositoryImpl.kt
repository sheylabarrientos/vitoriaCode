...
import com.sheyla.projeto_integrador.domain.*
import io.reactivex.Single

class MoviesRepositoryImpl: MoviesRepository {
    private val moviesRemoteSource: MoviesRemoteSource = com.sheyla.projeto_integrador.data.base.Network.getMoviesRemoteSource()
