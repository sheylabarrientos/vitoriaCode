    ...
    fun getService(): MoviesService {
        ...
        httpClient.addInterceptor { chain ->
            ...
            val url = originalHttpUrl.newBuilder() //Essa parte é uma interceptação da URL para colocar os dados desejados.
                .addQueryParameter("api_key", "9785973f3bb15c2a21794223b39bfcb8") //O parâmetro (aqui como "api_key") precisa estar como consta na documentação da API. No caso do TMDB, é "api_key".
