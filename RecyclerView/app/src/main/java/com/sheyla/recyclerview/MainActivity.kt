package com.sheyla.recyclerview
...
class MainActivity : AppCompatActivity() {
    ...
    private var adapter = MessageAdapter(messages,
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        lastCustomNonConfigurationInstance.let { savedMessages ->
            if (savedMessages is MutableList<*>) { messages.addAll(savedMessages.filterIsInstance(Message::class.java))
            }
        }
        initRecyclerView()
